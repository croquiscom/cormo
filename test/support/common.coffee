...
_g.BaseModel = _g.cormo.BaseModel
...
if process.env.DIRTY_TRACKING
  _g.BaseModel.dirty_tracking = process.env.DIRTY_TRACKING is 'true'
else
  _g.BaseModel.dirty_tracking = Math.floor(Math.random() * 2) isnt 0
