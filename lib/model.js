  ...
  Model = (function() {
    ...
    */
    ...
    Model.newModel = function(connection, name, schema) {
      ...
      Object.defineProperty(NewModel, '_adapter', {
    ...
    */
    ...
    Model._normalizeSchema = function() {
      var adapter, column, property, schema, type;
      ...
      for (column in schema) {
        ...
        if (type === Model.GeoPoint && !adapter.support_geopoint) {
