  ...
  DBModel = (function() {
    ...
    */
    ...
    DBModel._normalizeSchema = function() {
      var adapter, column, property, schema;
      ...
      for (column in schema) {
        ...
        if (schema[column].type === DBModel.GeoPoint && !adapter.support_geopoint) {
    ...
    */
    ...
    DBModel.hasMany = function(target_model, options) {
      ...
      target_model._addForeignKey(foreign_key, this._connection._adapter.key_type);
    ...
    */
    ...
    DBModel.belongsTo = function(target_model, options) {
      ...
      this._addForeignKey(foreign_key, target_model._adapter.key_type);
    ...
    */
    ...
    DBModel._addForeignKey = function(column, type) {
