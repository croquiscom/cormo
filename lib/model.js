  ...
  DBModel = (function() {
    ...
    */
    ...
    DBModel.prototype.validate = function(callback) {
      ...
      Object.keys(schema).forEach(function(field) {
        var property, value;
        property = schema[field];
        if (property.type === DBModel.Number) {
          value = Number(_this[field]);
          if (isNaN(value)) {
            return errors.push("'" + field + "' is not a number");
          } else {
    ...
    */
    ...
    DBModel.hasMany = function(target_model, options) {
      ...
      field = (options != null ? options.as : void 0) || inflector.tableize(target_model._name);
        ...
        get: function() {
          ...
          if (!this.hasOwnProperty(fieldGetter)) {
            getter = function(reload, callback) {
              ...
              self = getter.__scope;
              if ((!self[fieldCache] || reload) && self.id) {
                conditions = {};
    ...
    */
    ...
    DBModel.belongsTo = function(target_model, options) {
      ...
      field = (options != null ? options.as : void 0) || inflector.underscore(target_model._name);
      fieldCache = '__cache_' + field;
      fieldGetter = '__getter_' + field;
      return Object.defineProperty(this.prototype, field, {
        get: function() {
          ...
          if (!this.hasOwnProperty(fieldGetter)) {
            getter = function(reload, callback) {
              ...
              self = getter.__scope;
              if ((!self[fieldCache] || reload) && self[foreign_key]) {
