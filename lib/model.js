...
(function() {
  ...
  Model = (function() {
    ...
    function Model(data) {
      var adapter, column, ctor, id, last, obj, part, parts, path, property, schema, value, _fn, _i, _len, _ref,
        _this = this;
      data = data || {};
          ...
          if (parts.length > 1) {
            ...
            _fn = function(path) {
              if (!obj.hasOwnProperty(part)) {
                _this._objects[path] = {};
                return _this._defineIntermediateProperty(obj, part, path, false);
              }
            };
            for (_i = 0, _len = parts.length; _i < _len; _i++) {
              part = parts[_i];
    ...
    Model.prototype._defineIntermediateProperty = function(object, key, path, enumerable) {
      var _this = this;
      return Object.defineProperty(object, key, {
        configurable: true,
        enumerable: enumerable,
        get: function() {
          return _this._objects[path];
        },
        set: function(value) {
          var k, obj, v, _results;
          obj = _this._objects[path];
          for (k in obj) {
            obj[k] = void 0;
          }
          _results = [];
    ...
    Model.prototype.get = function(path) {
      return _getValue(this._attributes, path.split('.'));
    };
    ...
    Model.prototype.set = function(path, value) {
      var last, obj, parts, _ref, _ref1, _results;
      parts = path.split('.');
      if (!this._prev_attributes.hasOwnProperty(path)) {
        this._prev_attributes[path] = _getValue(this._attributes, parts);
      }
      _ref = _getRef(this, parts), obj = _ref[0], last = _ref[1];
      this._defineProperty(obj, last, path, value != null);
      _setValue(this._attributes, parts, value);
      _results = [];
      while (parts.length > 1) {
        parts.pop();
        _ref1 = _getRef(this, parts), obj = _ref1[0], last = _ref1[1];
        _results.push(this._defineIntermediateProperty(obj, last, parts.join('.'), true));
      }
      return _results;
    };
    ...
    Model.prototype._update = function(callback) {
      var adapter, ctor, data, parts, path, schema, value,
        _this = this;
      ctor = this.constructor;
      if (ctor._waitingForConnection(this, this._update, arguments)) {
        return;
      }
      if (ctor.dirty_tracking) {
        if (!this.isDirty()) {
        ...
        for (path in this._prev_attributes) {
          parts = path.split('.');
          value = _getValue(this._attributes, parts);
    ...
    Model.drop = function(callback) {
      ...
      return this._adapter.drop(this._name, _bindDomain(callback));
    };
