...
(function() {
  var Model, ModelCallback, ModelQuery, async, inflector, type, value, _, _ref,
  ...
  Model = (function() {
    ...
    function Model(data) {
      var adapter, column, ctor, id, property, schema, value;
      id = arguments[1];
      data = data || {};
    ...
    Model.prototype._buildSaveData = function() {
      ...
      Object.keys(schema).forEach(function(column) {
        var value;
        value = adapter.valueToDB(_this[column], column, schema[column]);
        if (value !== void 0) {
