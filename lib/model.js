...
(function() {
  var DBModel, DBQuery, async, inflector, type, value, _ref,
  ...
  */
  ...
  DBModel = (function() {
    ...
    */
    ...
    DBModel._normalizeSchema = function() {
      ...
      for (column in schema) {
        ...
        if (type === DBModel.GeoPoint && !adapter.support_geopoint) {
          throw new Error('this adapter does not support GeoPoint');
        }
      }
    };

    DBModel._waitingForConnection = function(object, method, args) {
    ...
    */
    ...
    DBModel.select = function(columns, callback) {
      var query;
    ...
    */
    ...
    DBModel._addForeignKey = function(column, target_adapter) {
      var type;
