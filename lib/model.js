  ...
  */
  ...
  DBModel = (function() {
    ...
    */
    ...
    DBModel._normalizeSchema = function(schema, connection) {
      var adapter, column, property;
    ...
    */
    ...
    DBModel.newModel = function(connection, name, schema) {
      var NewModel;
      this._normalizeSchema(schema, connection);
    ...
    */
    ...
    DBModel.belongsTo = function(target_model, options) {
      ...
      this._addForeignKey(foreign_key, target_model._connection._adapter.key_type);
