...
(function() {
  ...
  exports.hasMany = function(this_model, target_model, options) {
  ...
  exports.belongsTo = function(this_model, target_model, options) {
    var column, columnCache, columnGetter, foreign_key;
    if (options != null ? options.foreign_key : void 0) {
      foreign_key = options.foreign_key;
    } else if (options != null ? options.as : void 0) {
  ...
  exports.applyAssociations = function(connection, associations) {
    return associations.forEach(function(item) {
      ...
      return exports[item.type](this_model, target_model, options);
    });
  };
