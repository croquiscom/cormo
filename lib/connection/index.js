...
var Connection, ConnectionAssociationMixin, ConnectionBase, ConnectionManipulateMixin, EventEmitter, Model, Promise, Toposort, _, deasync, inspect, redis;
          ...
          this._promise_schema_applied = this._promise_connection.then(async() => {
            ...
            try {
              ...
              return (await Promise.each(foreign_keys_commands, (args) => {
                return this._adapter.createForeignKey.apply(this._adapter, args);
              }));
            } finally {
              if (options.verbose) {
