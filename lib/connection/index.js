...
var Bluebird, Connection, ConnectionAssociationMixin, ConnectionBase, ConnectionManipulateMixin, EventEmitter, Model, Toposort, _, inspect, redis;
...
ConnectionBase = class ConnectionBase extends EventEmitter {
  ...
  constructor(adapter_name, settings) {
    ...
    this._adapter = Bluebird.promisifyAll(require(__dirname + '/../adapters/' + adapter_name)(this));
