          ...
          if (!_this._applying_schemas) {
            ...
            _this._promise_schema_applied = _this._promise_connection.then(function() {
              return _this._adapter.getSchemasAsync().tap(function(current) {
                var add_columns_commands, column, model, modelClass, property, ref, ref1, ref2, ref3, ref4;
                add_columns_commands = [];
                ref = _this.models;
                for (model in ref) {
                  modelClass = ref[model];
                  ref1 = modelClass._schema;
                  for (column in ref1) {
                    property = ref1[column];
                    if (((ref2 = current.tables) != null ? ref2[modelClass.tableName] : void 0) && !((ref3 = current.tables) != null ? (ref4 = ref3[modelClass.tableName]) != null ? ref4[property._dbname] : void 0 : void 0)) {
                      if (options.verbose) {
