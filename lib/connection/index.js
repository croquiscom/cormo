        ...
        return function() {
          ...
          if (!_this._applying_schemas) {
            ...
            _this._promise_schema_applied = _this._promise_connection.then(function() {
              return _this._adapter.getSchemasAsync().then(function(current) {
                var model, modelClass, tables_commands;
                tables_commands = (function() {
                  var ref, results;
                  ref = this.models;
                  results = [];
                  for (model in ref) {
                    ...
                    if (current.tables[modelClass.tableName]) {
                      results.push(console.log(model, 'exist'));
                    } else {
                      results.push(this._adapter.createTableAsync(model));
                    }
                  }
                  return results;
                }).call(_this);
