...
class ConnectionAssociation {
    ...
    getInconsistencies() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            result = {};
            promises = Object.keys(this.models).map((model) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (integrities.length > 0) {
                    records = (yield modelClass.select(''));
                    ids = records.map(function (record) {
                        return record.id;
                    });
                    sub_promises = integrities.map((integrity) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    getter = function (reload) {
                        return __awaiter(this, void 0, void 0, function* () {
                            ...
                            if ((!self[columnCache] || reload) && self.id) {
                                records = (yield target_model.where(_.zipObject([foreign_key], [self.id])));
                    ...
                    getter = function (reload) {
                        return __awaiter(this, void 0, void 0, function* () {
                            ...
                            if ((!self[columnCache] || reload) && self[foreign_key]) {
                                record = (yield target_model.find(self[foreign_key]));
                                self[columnCache] = record;
                                return record;
                            }
                            else {
