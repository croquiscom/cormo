...
(function() {
  var ConnectionAssociation, async, console_future, inflector, types, _;
      ...
      return console_future.execute(callback, (function(_this) {
        return function(callback) {
          ...
          if (association.type === 'belongsTo') {
            return _this._fetchAssociatedBelongsTo(records, association.target_model, column, select, options, callback);
          } else if (association.type === 'hasMany') {
            return _this._fetchAssociatedHasMany(records, association.target_model, association.foreign_key, column, select, options, callback);
          } else {
            return callback(new Error("unknown column '" + column + "'"));
          }
        };
