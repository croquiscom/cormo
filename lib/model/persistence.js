...
ModelPersistenceMixin = function(Base) {
  return class extends Base {
    ...
    static createBulk(data, callback) {
      return this._checkReady().then(() => {
        ...
        return Promise.all(promises).then(() => {
          ...
          return this._createBulk(records).finally(function() {
            records.forEach(function(record) {
    ...
    _create(options) {
      ...
      return ctor._adapter.createAsync(ctor._name, data).then((id) => {
    ...
    _update(options) {
      ...
      if (ctor.dirty_tracking) {
        ...
        return ctor._adapter.updateAsync(ctor._name, data).then(() => {
          return this._prev_attributes = {};
        });
      }
    }
    ...
    save(options, callback) {
      ...
      return this.constructor._checkReady().then(() => {
        ...
        if (this.id) {
          ...
          return this._create(options).finally(() => {
