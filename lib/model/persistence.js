...
(function() {
  ...
  ModelPersistence = (function() {
    ...
    ModelPersistence.create = function(data, options, callback) {
      if (this._waitingForReady(this, this.create, arguments)) {
        return;
      }
    ...
    ModelPersistence.createBulk = function(data, callback) {
      var records;
      if (this._waitingForReady(this, this.createBulk, arguments)) {
        return;
      }
      ...
      records = data.map((function(_this) {
    ...
    ModelPersistence.prototype._create = function(options, callback) {
      ...
      return ctor._adapter.create(ctor._name, data, _bindDomain((function(_this) {
    ...
    ModelPersistence.prototype._update = function(options, callback) {
      ...
      if (ctor.dirty_tracking) {
        ...
        return ctor._adapter.update(ctor._name, data, _bindDomain((function(_this) {
          return function(error) {
            if (error) {
              return callback(error, _this);
            }
    ...
    ModelPersistence.prototype.save = function(options, callback) {
      ...
      if (this.id) {
        ...
        return this._update(options, (function(_this) {
        ...
        return this._create(options, (function(_this) {
          return function(error, record) {
