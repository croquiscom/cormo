...
class ModelQuery {
    ...
    static count(condition) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield new Query(this).where(condition).count());
        });
    }
    //#
    ...
    static update(updates, condition) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield new Query(this).where(condition).update(updates));
        });
    }
    //#
    ...
    static delete(condition) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield new Query(this).where(condition).delete());
        });
    }
}
