...
class Model {
    ...
    static find(id) {
        return new query_1.Query(this).find(id);
    }
    /**
    ...
    static findPreserve(ids) {
        return new query_1.Query(this).findPreserve(ids);
    }
    /**
     * Finds records by conditions
     */
    static where(condition) {
        return new query_1.Query(this).where(condition);
    }
    /**
     * Selects columns for result
     */
    static select(columns) {
        return new query_1.Query(this).select(columns);
    }
    /**
     * Specifies orders of result
     */
    static order(orders) {
        return new query_1.Query(this).order(orders);
    }
    /**
