...
Query = class Query {
  ...
  _exec(options) {
    ...
    return this._adapter.findAsync(this._name, this._conditions, this._options).then((records) => {
  ...
  count(callback) {
    return this._model._checkReady().then(() => {
      ...
      return this._adapter.countAsync(this._name, this._conditions, this._options);
    }).nodeify(bindDomain(callback));
  }
  ...
  update(updates, callback) {
    return this._model._checkReady().then(() => {
      ...
      return this._adapter.updatePartialAsync(this._name, data, this._conditions, this._options);
    }).nodeify(bindDomain(callback));
  }
  ...
  upsert(updates, callback) {
    return this._model._checkReady().then(() => {
      ...
      return this._adapter.upsertAsync(this._name, data, this._conditions, this._options);
    }).nodeify(bindDomain(callback));
  }
