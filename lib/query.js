...
(function() {
  ...
  Query = (function() {
    ...
    Query.prototype["delete"] = function(options, callback) {
      ...
      if (this._model.archive) {
        return this._model.where(this._conditions, function(error, records) {
          if (error) {
            return callback(error);
          }
          ...
          return _this._connection.models['_Archive'].createBulk(records, function(error, records) {
            if (error) {
              return callback(error);
            }
