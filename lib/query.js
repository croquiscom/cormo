...
(function() {
  ...
  Query = (function() {
    ...
    Query.prototype._exec = function(options, callback) {
      ...
      return this._adapter.find(this._name, this._conditions, this._options, _bindDomain((function(_this) {
    ...
    Query.prototype._execAndInclude = function(options, callback) {
      return this._exec(options, (function(_this) {
        return function(error, records) {
          if (error) {
            return callback(error);
          }
    ...
    Query.prototype._doIntegrityActions = function(integrities, ids, callback) {
      return async.forEach(integrities, (function(_this) {
        return function(integrity, callback) {
          var conditions, data;
