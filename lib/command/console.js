...
(function() {
  var CommandConsole, Connection, Fiber, Future, Model, Query, addArgCompleter, addHistory, addMultilineHandler, coffee, commander, console_exports, console_future, fs, path, prettyErrorMessage, repl, util, vm;
  ...
  CommandConsole = (function() {
    ...
    CommandConsole.prototype._setupContext = function(context) {
      var connection, key, model, modelClass, object, _ref, _results;
      ...
      _results = [];
      for (key in console_exports) {
        object = console_exports[key];
        _results.push(context[key] = object);
      }
      return _results;
    };
