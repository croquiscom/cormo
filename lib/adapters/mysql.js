...
class MySQLAdapter extends sql_base_1.SQLAdapterBase {
    ...
    _getTables() {
        return __awaiter(this, void 0, void 0, function* () {
            let tables = yield this._client.queryAsync('SHOW TABLES');
    ...
    _getSchema(table) {
        return __awaiter(this, void 0, void 0, function* () {
            const columns = yield this._client.queryAsync(`SHOW COLUMNS FROM \`${table}\``);
            const schema = {};
    ...
    _getIndexes() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const rows = yield this._client.queryAsync(sql, [this._database]);
            const indexes = {};
