...
class MySQLAdapter extends sql_base_1.SQLAdapterBase {
    ...
    _getTables() {
        return __awaiter(this, void 0, void 0, function* () {
            var tables;
            tables = (yield this._client.queryAsync("SHOW TABLES"));
    ...
    _getSchema(table) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            columns = (yield this._client.queryAsync(`SHOW COLUMNS FROM \`${table}\``));
            schema = {};
    ...
    _getIndexes() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            rows = (yield this._client.queryAsync("SELECT * FROM INFORMATION_SCHEMA.STATISTICS WHERE TABLE_SCHEMA = ? ORDER BY SEQ_IN_INDEX", [this._database]));
            indexes = {};
    ...
    _getForeignKeys() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            rows = (yield this._client.queryAsync("SELECT * FROM INFORMATION_SCHEMA.KEY_COLUMN_USAGE WHERE REFERENCED_TABLE_NAME IS NOT NULL AND CONSTRAINT_SCHEMA = ?", [this._database]));
            foreign_keys = {};
            for (j = 0, len = rows.length; j < len; j++) {
                row = rows[j];
    ...
    getSchemas() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            indexes = (yield this._getIndexes());
            foreign_keys = (yield this._getForeignKeys());
            return {
    ...
    createTable(model) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield this._client.queryAsync(sql);
            }
            catch (error1) {
                error = error1;
    ...
    drop(model) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield this._client.queryAsync(`DROP TABLE IF EXISTS \`${tableName}\``);
            }
            catch (error1) {
                error = error1;
                throw MySQLAdapter.wrapError('unknown error', error);
    ...
    create(model, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                result = (yield this._client.queryAsync(sql, values));
            }
            catch (error1) {
                error = error1;
    ...
    update(model, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield this._client.queryAsync(sql, values);
            }
            catch (error1) {
                error = error1;
                throw _processSaveError(error);
    ...
    findById(model, id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (options.explain) {
                return (yield this._client.queryAsync(`EXPLAIN ${sql}`, id));
            }
            try {
                result = (yield this._client.queryAsync(sql, id));
            }
            catch (error1) {
                error = error1;
                throw MySQLAdapter.wrapError('unknown error', error);
    ...
    find(model, conditions, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (options.explain) {
                return (yield this._client.queryAsync(`EXPLAIN ${sql}`, params));
            }
            try {
                result = (yield this._client.queryAsync(sql, params));
            }
            catch (error1) {
                error = error1;
                throw MySQLAdapter.wrapError('unknown error', error);
    ...
    connect(settings) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield this._createDatabase(client);
            }
            catch (error1) {
                error = error1;
                client.end();
            ...
            try {
                yield this._checkFeatures(client);
            }
            finally {
                client.end();
            }
    ...
    _createDatabase(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return (yield client.queryAsync(`USE \`${this._database}\``));
            }
            catch (error1) {
                error = error1;
                if (error.code === 'ER_BAD_DB_ERROR') {
                    try {
                        yield client.queryAsync(`CREATE DATABASE \`${this._database}\``);
                    }
                    catch (error1) {
                        error = error1;
                        throw MySQLAdapter.wrapError('unknown error', error);
                    }
                    return (yield this._createDatabase(client));
                }
                else {
    ...
    _checkFeatures(client) {
        return __awaiter(this, void 0, void 0, function* () {
            var error;
            try {
                yield client.queryAsync("CREATE TABLE _temp (date DATETIME(10))");
            }
            catch (error1) {
                error = error1;
