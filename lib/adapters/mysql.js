...
(function() {
  var MySQLAdapter, SQLAdapterBase, _, _propertyToSQL, _typeToSQL, e, mysql, stream, types,
  ...
  MySQLAdapter = (function(superClass) {
    ...
    MySQLAdapter.prototype.connect = function(settings, callback) {
      ...
      return client.connect((function(_this) {
        return function(error) {
          ...
          return _this._createDatabase(client, settings, function(error) {
            client.end();
            if (error) {
              return callback(error);
            }
    ...
    MySQLAdapter.prototype._createDatabase = function(client, settings, callback) {
      return client.query("USE `" + settings.database + "`", (function(_this) {
        return function(error) {
          var msg;
          if (!error) {
            return callback(null);
          ...
          if (error.code === 'ER_BAD_DB_ERROR') {
            return client.query("CREATE DATABASE `" + settings.database + "`", function(error) {
              ...
              return _this._createDatabase(client, settings, callback);
            });
          } else {
