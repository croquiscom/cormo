...
(function() {
  ...
  MySQLAdapter = (function(_super) {
    ...
    MySQLAdapter.prototype._buildUpdateSet = function(model, data, insert) {
      var column, dbname, fields, places, property, schema, values;
    ...
    MySQLAdapter.prototype.create = function(model, data, callback) {
      ...
      _ref = this._buildUpdateSet(model, data, true), values = _ref[0], fields = _ref[1], places = _ref[2];
    ...
    MySQLAdapter.prototype.createBulk = function(model, data, callback) {
      ...
      data.forEach(function(item) {
        var places_sub, values_sub, _ref;
        _ref = _this._buildUpdateSet(model, item, true), values_sub = _ref[0], fields = _ref[1], places_sub = _ref[2];
    ...
    MySQLAdapter.prototype.update = function(model, data, callback) {
      ...
      _ref = this._buildUpdateSet(model, data), values = _ref[0], fields = _ref[1];
      values.push(data.id);
