...
class MongoDBAdapter extends base_1.AdapterBase {
    ...
    _getTables() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            collections = (yield this._db.listCollections().toArray());
    ...
    _getSchema(table) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield 'NO SCHEMA');
        });
    }
    _getIndexes(table) {
        return __awaiter(this, void 0, void 0, function* () {
            var indexes, j, len, row, rows;
            rows = (yield this._db.collection(table).listIndexes().toArray());
            indexes = {};
    ...
    create(model, data) {
        return __awaiter(this, void 0, void 0, function* () {
            var id, result;
            try {
                result = (yield this._collection(model).insert(data, {
                    safe: true
                }));
            }
            catch (error) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (data.length > 1000) {
                ...
                for (j = 0, len = chunks.length; j < len; j++) {
                    chunk = chunks[j];
                    ids = (yield this.createBulk(model, chunk));
    ...
    update(model, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            delete data.id;
            try {
                yield this._collection(model).update({
                    _id: id
                }, data, {
                    safe: true
                });
    ...
    updatePartial(model, data, conditions, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                result = (yield this._collection(model).update(conditions, update_ops, {
                    safe: true,
                    multi: true
                }));
    ...
    upsert(model, data, conditions, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield this._collection(model).update(conditions, update_ops, {
                    safe: true,
                    upsert: true
                });
            }
    ...
    findById(model, id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (options.explain) {
                ...
                return (yield this._collection(model).findOne({
                    _id: id
                }, client_options));
            }
            try {
                result = (yield this._collection(model).findOne({
                    _id: id
                }, client_options));
            }
            catch (error) {
    ...
    find(model, conditions, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (options.group_by || options.group_fields) {
                ...
                if (options.explain) {
                    cursor = (yield this._collection(model).aggregate(pipeline, {
                        explain: true
                    }));
                ...
                if (options.explain) {
                    client_options.explain = true;
                    cursor = (yield this._collection(model).find(conditions, client_options));
                    return (yield cursor.toArray());
                }
                try {
                    cursor = (yield this._collection(model).find(conditions, client_options));
    ...
    count(model, conditions, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (options.group_by || options.group_fields) {
                ...
                try {
                    count = (yield this._collection(model).countDocuments(conditions));
                }
                catch (error) {
                    throw MongoDBAdapter.wrapError('unknown error', error);
                }
    ...
    delete(model, conditions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                //console.log JSON.stringify conditions
                result = (yield this._collection(model).remove(conditions, {
                    safe: true
                }));
            }
            catch (error) {
    ...
    connect(settings) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                client = (yield mongodb.MongoClient.connect(url, {
