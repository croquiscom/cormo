...
class MongoDBAdapter extends base_1.AdapterBase {
    ...
    createTable(model) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const index of indexes) {
                yield collection.createIndex(index[0], index[1]);
            }
        });
    }
    createIndex(model, index) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield collection.createIndex(index.columns, options);
            }
            catch (error) {
    ...
    create(model, data) {
        return __awaiter(this, void 0, void 0, function* () {
            let result;
            try {
                result = yield this._collection(model).insertOne(data, { safe: true });
            }
            catch (error) {
    ...
    createBulk(model, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let result;
            try {
                result = (yield this._collection(model).insertMany(data, { safe: true }));
            }
            catch (error) {
                throw _processSaveError(error);
            }
    ...
    update(model, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            delete data.id;
            try {
                yield this._collection(model).replaceOne({ _id: id }, data, { safe: true });
            }
            catch (error) {
                throw _processSaveError(error);
            }
    ...
    updatePartial(model, data, conditions, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this._collection(model).updateMany(conditions, update_ops, { safe: true, multi: true });
    ...
    upsert(model, data, conditions, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield this._collection(model).updateMany(conditions, update_ops, { safe: true, upsert: true });
            }
            catch (error) {
                throw _processSaveError(error);
            }
    ...
    delete(model, conditions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                // console.log(JSON.stringify(conditions))
                const result = yield this._collection(model).deleteMany(conditions, { safe: true });
                return result.result.n;
            }
            catch (error) {
                throw MongoDBAdapter.wrapError('unknown error', error);
