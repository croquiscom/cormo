...
(function() {
  var AdapterBase, MongoDBAdapter, ObjectID, async, error, mongodb, tableize, types, _buildGroupFields, _buildWhere, _buildWhereSingle, _convertValueToObjectID,
  ...
  MongoDBAdapter = (function(_super) {
    ...
    MongoDBAdapter.prototype.find = function(model, conditions, options, callback) {
      var client_options, e, field, fields, obj, orders, pipeline,
        _this = this;
