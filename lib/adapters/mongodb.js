...
(function() {
  var AdapterBase, MongoDBAdapter, ObjectID, async, mongodb, tableize, _buildWhere,
  ...
  _buildWhere = function(conditions, conjunction) {
    var key, keys, obj, sub_key, subs, value;
    if (conjunction == null) {
      conjunction = '$and';
    }
  ...
  MongoDBAdapter = (function(_super) {
    ...
    */
    ...
    MongoDBAdapter.prototype._applySchema = function(model, callback) {
      var collection, column, property, unique_columns, _ref;
      ...
      return async.forEach(unique_columns, function(column, callback) {
        return collection.ensureIndex(column, {
          safe: true,
          unique: true,
          sparse: true
        }, function(error) {
    ...
    */
    ...
    MongoDBAdapter.prototype._convertToModelInstance = function(model, data) {
      ...
      for (column in modelClass._schema) {
