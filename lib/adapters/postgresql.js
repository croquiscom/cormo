  ...
  */
  ...
  PostgreSQLAdapter = (function(_super) {
    ...
    */
    ...
    function PostgreSQLAdapter(connection, client) {
    ...
    */
    ...
    PostgreSQLAdapter.prototype._convertToModelInstance = function(model, data) {
      ...
      for (column in _ref) {
        ...
        if (property.type === types.ForeignKey) {
    ...
    */
    ...
    PostgreSQLAdapter.prototype.findById = function(model, id, callback) {
      var table,
        _this = this;
      table = tableize(model);
      return this._query("SELECT * FROM " + table + " WHERE id=$1 LIMIT 1", [id], function(error, result) {
        var rows;
        rows = result != null ? result.rows : void 0;
        if (error) {
          return callback(PostgreSQLAdapter.wrapError('unknown error', error));
    ...
    */
    ...
    PostgreSQLAdapter.createAdapter = function(connection, settings, callback) {
      return pg.connect({
        host: settings.host,
        port: settings.port,
        user: settings.user,
