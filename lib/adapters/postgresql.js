...
class PostgreSQLAdapter extends sql_base_1.SQLAdapterBase {
    ...
    _getTables() {
        return __awaiter(this, void 0, void 0, function* () {
            var result, tables;
            result = (yield this._pool.query("SELECT table_name FROM INFORMATION_SCHEMA.TABLES WHERE table_schema = 'public' AND table_type = 'BASE TABLE'"));
    ...
    _getSchema(table) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            result = (yield this._pool.query("SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE table_name=$1", [table]));
            schema = {};
            ref = result.rows;
    ...
    _getIndexes() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            result = (yield this._pool.query("SELECT t.relname AS table_name, i.relname AS index_name, a.attname AS column_name FROM pg_class t, pg_class i, pg_index ix, pg_attribute a WHERE t.oid = ix.indrelid AND i.oid = ix.indexrelid AND a.attrelid = t.oid AND a.attnum = ANY(ix.indkey)"));
            indexes = {};
            ref = result.rows;
            for (i = 0, len = ref.length; i < len; i++) {
                row = ref[i];
