...
(function() {
  var PostgreSQLAdapter, QueryStream, SQLAdapterBase, _, _propertyToSQL, _typeToSQL, async, e, error1, pg, stream, types,
  ...
  PostgreSQLAdapter = (function(superClass) {
    ...
    PostgreSQLAdapter.prototype.stream = function(model, conditions, options, callback) {
      var error2, params, readable, ref, sql, transformer;
      if (!QueryStream) {
