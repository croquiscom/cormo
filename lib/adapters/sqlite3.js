  ...
  */
  ...
  SQLite3Adapter = (function(_super) {
    ...
    */
    ...
    function SQLite3Adapter(connection, client) {
    ...
    */
    ...
    SQLite3Adapter.prototype.findById = function(model, id, callback) {
      var table,
        _this = this;
      table = tableize(model);
      return this._query('all', "SELECT * FROM " + table + " WHERE id=? LIMIT 1", id, function(error, result) {
        if (error) {
          return callback(SQLite3Adapter.wrapError('unknown error', error));
        }
    ...
    */
    ...
    SQLite3Adapter.createAdapter = function(connection, settings, callback) {
      var client;
