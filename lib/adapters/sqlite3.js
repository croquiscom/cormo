...
var Bluebird, SQLAdapterBase, SQLite3Adapter, _, _processSaveError, _propertyToSQL, _typeToSQL, e, sqlite3, stream, types;
      ...
      try {
        this._client = (await new Promise((resolve, reject) => {
          ...
          return client = new sqlite3.Database(settings.database, (error) => {
            ...
            return resolve(Bluebird.promisifyAll(client));
          });
        }));
      } catch (error1) {
        error = error1;
