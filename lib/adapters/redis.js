...
var AdapterBase, Bluebird, RedisAdapter, _, error, redis, tableize, types;
...
RedisAdapter = (function() {
  ...
  class RedisAdapter extends AdapterBase {
    ...
    async connect(settings) {
      this._client = Bluebird.promisifyAll(redis.createClient(settings.port || 6379, settings.host || '127.0.0.1'));
