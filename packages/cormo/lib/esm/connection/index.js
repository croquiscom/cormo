...
import { createAdapter as createMongoDBAdapter } from '../adapters/mongodb.js';
import { createAdapter as createMySQLAdapter } from '../adapters/mysql.js';
import { createAdapter as createPostgreSQLAdapter, } from '../adapters/postgresql.js';
import { createAdapter as createRedisAdapter } from '../adapters/redis.js';
import { createAdapter as createSQLite3Adapter } from '../adapters/sqlite3.js';
import { createAdapter as createSQLite3MemoryAdapter } from '../adapters/sqlite3_memory.js';
import { ColorConsoleLogger, ConsoleLogger, EmptyLogger } from '../logger/index.js';
    ...
    async getSchemaChanges() {
        ...
        for (const model_name in this.models) {
            ...
            for (const index in current.indexes?.[model_class.table_name]) {
                ...
                if (!_.find(model_class._indexes, (item) => item.options.name === index) &&
