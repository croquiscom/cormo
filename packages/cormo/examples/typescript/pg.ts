...
export const connection = new cormo.PostgreSQLConnection({
...
@cormo.Model({ connection, description: 'User model', pg_schema: 'cormo' })
...
async function run() {
  await connection.adapter.query('CREATE SCHEMA IF NOT EXISTS cormo');
